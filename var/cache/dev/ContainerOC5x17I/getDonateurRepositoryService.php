 ...
 */
class getDonateurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DonateurRepository' shared autowired service.
     *
     * @return \App\Repository\DonateurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DonateurRepository.php';

        return $container->privates['App\\Repository\\DonateurRepository'] = new \App\Repository\DonateurRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
