 ...
 */
class getUsersAuthAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\UsersAuthAuthenticator' shared autowired service.
     *
     * @return \App\Security\UsersAuthAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'UsersAuthAuthenticator.php';

        return $container->privates['App\\Security\\UsersAuthAuthenticator'] = new \App\Security\UsersAuthAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
