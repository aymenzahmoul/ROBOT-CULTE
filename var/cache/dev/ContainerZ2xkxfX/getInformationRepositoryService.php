 ...
 */
class getInformationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InformationRepository' shared autowired service.
     *
     * @return \App\Repository\InformationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InformationRepository.php';

        return $container->privates['App\\Repository\\InformationRepository'] = new \App\Repository\InformationRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
