 ...
 */
class getMaisonDeCulteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MaisonDeCulteRepository' shared autowired service.
     *
     * @return \App\Repository\MaisonDeCulteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MaisonDeCulteRepository.php';

        return $container->privates['App\\Repository\\MaisonDeCulteRepository'] = new \App\Repository\MaisonDeCulteRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
