 ...
 */
class getContributionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContributionRepository' shared autowired service.
     *
     * @return \App\Repository\ContributionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContributionRepository.php';

        return $container->privates['App\\Repository\\ContributionRepository'] = new \App\Repository\ContributionRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
